...
| delegatedConsents | Enabled consents to be collected on behalf of a merchant. This scope is only supported in Vipps login from phone number, see [Merchant delegated consents](flows/ciba-flows.md#merchants-delegated-consents).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | yes                   |
