...
We recommend to fetch these dynamically, however the response from this endpoint rarely changes.
...
| requested_flow        | Optional. Request a specific flow for the user. See [App integration](./flows/app-integration.md), [Automatic return from Vipps app](./overview.md#automatic-return-from-vipps-app) and [No dialog flow](./overview.md##no-dialog-flow)                                                                                                                                                                                          |
