...
* [Integrating with Vipps Login from phone number](#integrating-with-vipps-login-from-phone-number)
  ...
  * [Merchants delegated consents](#merchants-delegated-consents)
    * [Activation](#activation)
    * [Overview](#overview-2)
    * [Call by call](#call-by-call-3)
    * [Authentication request](#authentication-request-1)
      * [Error responses](#error-responses-2)
      * [Successful responses](#successful-responses-1)
      * [Token request](#token-request-1)
      * [Polling](#polling-1)
* [Revoke Consent Webhook](#revoke-consent-webhook)
* [Partner keys](#partner-keys)
  * [Partner key in the Vipps Login in browser flow](#partner-key-in-the-vipps-login-in-browser-flow)
    * [Authorization endpoint](#authorization-endpoint)
    * [Token endpoint](#token-endpoint)
  * [Partner in Vipps Login from phone number flow](#partner-in-vipps-login-from-phone-number-flow)
    * [Example /backchannel/authentication request](#example-backchannelauthentication-request)
    * [Example /token request (without redirect)](#example-token-request-without-redirect)
