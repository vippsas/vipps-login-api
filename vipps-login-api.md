...
4. The `app_callback_uri` will return the user to the merchant app. The merchant app must ensure that the webview is still present after returning from the Vipps app, so that the login can complete.
