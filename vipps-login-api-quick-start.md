...
### Make API calls for Vipps Login from phone number (CIBA without redirect)
...
### Make API calls for Vipps Login from phone number (CIBA with redirect)
